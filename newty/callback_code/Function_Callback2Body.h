#ifndef FUNCTION_CB_2_BODY_H
#define FUNCTION_CB_2_BODY_H
//======================================================================
// Function_Callback2Body.h
//
//
...
class Function_Callback2Body:
  public Base_Callback2Body<A1,A2>
{
public:
  Function_Callback2Body(const Function& f): f_(f) {}
