#ifndef NIL_CB_2_W_RET_BODY_H
#define NIL_CB_2_W_RET_BODY_H
//======================================================================
// Nil_Callback2wRetBody.h
//
//
...
#include "Base_Callback2wRetBody.h" // base class
...
class Nil_Callback2wRetBody:
  public Base_Callback2wRetBody<A1,A2,R>
{
public:

  /*virtual*/ R operator()(A1, A2) 
  {
