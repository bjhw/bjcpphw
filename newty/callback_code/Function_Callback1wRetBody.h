#ifndef FUNCTION_CB_1_W_RET_BODY_H
#define FUNCTION_CB_1_W_RET_BODY_H
//======================================================================
// Function_Callback1wRetBody.h
//
//
...
class Function_Callback1wRetBody:
  public Base_Callback1wRetBody<A1,R>
{
public:
  Function_Callback1wRetBody(const Function& f): f_(f) {}
