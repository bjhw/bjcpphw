#ifndef MEMBER_CB_0_W_RET_BODY_H
#define MEMBER_CB_0_W_RET_BODY_H
//======================================================================
// Callback0wRetMemberBody.h
//
//
...
class Member_Callback0wRetBody:
  public Base_Callback0wRetBody<R>
{
public:
  Member_Callback0wRetBody(Client* client, Member member):
    client_(client), 
    member_(member)
  {}
