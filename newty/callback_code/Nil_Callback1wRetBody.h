#ifndef NIL_CB_1_W_RET_BODY_H
#define NIL_CB_1_W_RET_BODY_H
//======================================================================
// Nil_Callback1wRetBody.h
//
//
...
#include "Base_Callback1wRetBody.h" // base class
...
class Nil_Callback1wRetBody:
  public Base_Callback1wRetBody<A1,R>
{
public:

  /*virtual*/ R operator()(A1) 
  {
