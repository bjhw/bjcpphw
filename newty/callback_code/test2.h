...
{
public:
  test(Members<T>& members, void (functionPtr)(T,T)):
  nil_(),
  function_(make_callback((Callback2<T,T>*)0, functionPtr)),
  functionObject_(
		  make_callback
		  (
		   (Callback2<T,T>*)0, 
...
,
  ...
  static void isEqual(const Callback2<T,T>& cb1,
		 const Callback2<T,T>& cb2)
  {
    if(cb1 == cb2)
      cout << ".";
    else
  ...
  static void notEqual(const Callback2<T,T>& cb1,
		 const Callback2<T,T>& cb2)
  {
    if(cb1 == cb2)
      {
  ...
  static void isEqual_lt(const Callback2<T,T>& cb1,
		 const Callback2<T,T>& cb2)
  {
    if((cb1 < cb2) || (cb2 < cb1))
      {
  ...
  static void notEqual_lt(const Callback2<T,T>& cb1,
		 const Callback2<T,T>& cb2)
  {
    if((cb1 < cb2) || (cb2 < cb1))
      cout << ".";
  ...
  void equality_tests()
  {
    Callback2<T,T> nil_copy(nil_);
    Callback2<T,T> function_copy(function_);
    Callback2<T,T> functionObject_copy(functionObject_);
    Callback2<T,T> member_function_copy(member_function_);
#ifndef __GNUG__
    Callback2<T,T> 
...
private:
  Callback2<T,T> nil_;
  Callback2<T,T> function_;
  Callback2<T,T> functionObject_;
  Callback2<T,T> member_function_;

#ifndef __GNUG__
  Callback2<T,T> member_functionPointer_;
  Callback2<T,T> member_functionObject_;
#endif
