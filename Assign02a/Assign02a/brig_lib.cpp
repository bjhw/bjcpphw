...
Usage: AskUserForInputFile(prompt, infile)
------------------------------------------
...
of file is required.
From Stanford CS106B manual, p. 131; Eric Roberts et al.
 */
...
Usage: PromptUserToOpenFile(infile)     [Deprecated]
----------------------------------------------------
User types a filename, this function opens the file.
 */
void PromptUserToOpenFile(ifstream &infile, string prompt = "Enter filename (RETURN to quit): ") {
...
Usage: ReadTextFile(infile, lines)
-----------------------------------
This function reads a file and updates a 'Vector<string>' vector with those lines.
From Stanford CS106B manual, p. 130; Eric Roberts et al.
*/
